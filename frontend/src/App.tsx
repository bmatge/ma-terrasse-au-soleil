...
const METRO_STATIONS = [
  ...
  "École Militaire","Edgar Quinet","Étienne Marcel","Europe","Exelmans",
  ...
  "Nation","Notre-Dame-de-Lorette","Notre-Dame-des-Champs",
  "Oberkampf","Odéon","Olympiades","Opéra","Ourcq",
  "Palais Royal - Musée du Louvre","Parmentier","Passy","Pasteur","Pelleport",
  ...
  "Poissonnière","Pont de l'Alma","Pont Marie","Pont Neuf",
  "Porte d'Italie","Porte d'Ivry","Porte d'Orléans","Porte Dauphine",
  "Porte de Bagnolet","Porte de Charenton","Porte de Choisy","Porte de Clichy",
  ...
  "Trocadéro","Tuileries",
  "Vaneau","Varenne","Vaugirard","Vavin","Victor Hugo","Villiers",
